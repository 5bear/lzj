    ...
    <div id="page-wrapper">
            ...
            <div class="col-lg-6 col-lg-offset-3">
                <table class="table vertical-table vertical-table1">
                    ...
                    <tr>
                        <td>执行时间(年)</td>
                        <td>
                            <select class="table-input" id="happen-year">
        ...
        <div class="row">
            <div class="col-lg-4 col-lg-offset-4 col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 text-center">
                <button class="btn btn-default" data-toggle="modal" onclick="editPackage('${sessionScope.company}')" >提交</button>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function editPackage(company){
        ...
        $.ajax({
            url:"<%=request.getContextPath()%>/Package/edit",
            type:"post",
