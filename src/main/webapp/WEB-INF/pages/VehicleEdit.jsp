...
<head>
    ...
    <!--<script>
        var sel=${Vehicle_edit.vehicleLicense};
            ...
            <div class="col-lg-6 col-lg-offset-3">
                <form>
                    <table class="table vertical-table">
                        ...
                        <tr>
                            <td>车辆牌照</td>
                            <td><input type="text" class="table-input"  id="vehicleLicense" value="${Vehicle_edit.vehicleLicense}"/></td>
                        </tr>
                        <tr>
                            <td>车辆型号</td>
...
<script type="text/javascript">
    ...
    function go()
    {
        location.href = "<%=request.getContextPath()%>/Vehicle/list";
    }
    ...
    function addVehicle(company){
        ...
        if(typeof (vehicleType)=="undefined" || vehicleType==null ||vehicleType=="请选择"){
            ...
            alert("车辆设备编号必须填写");
        }else if(vehicleType=="巡视车" && (eFenceId==null || eFenceId=="")){
            alert("巡视车必须选择电子围栏");
        }else{
        $.ajax({
            url:"<%=request.getContextPath()%>/Vehicle/edit",
            type:"post",
            data:{
                id:'${Vehicle_edit.id}',
                company:company,
